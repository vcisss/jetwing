...
function hadiahbonus()
{
 	...
 	if(document.getElementById("rup").value=="B")
 	{
		...
		$("#footerdetail").attr("disabled", "disabled");
	}
	else
	{
	    $("#footerdetail").removeAttr("disabled");
...
function ubah1(namasel, namacek)
{
...
function cekmore(){
	...
	{
	  	if(cekoption("footerdetail","Memilih Discount Footer / Detail"))
		   return true;
		else return false;
	}
}