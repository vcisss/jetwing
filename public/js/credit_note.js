function cekTheform()
{
	var pcode1 = document.getElementsByName("pcode[]").length;
     ...
     /*if(document.getElementById("v_subdivisi").value=="")
    {
...
function deleteTrans(cnno,url)
{
	...
	if (r==true)
	{
		window.location = url+"index.php/transaksi/credit_note/delete_trans/"+cnno;	
	}
	else
	{
  		return false;
...
//add
function deleteDetail(cndid,coano,adduser,url)
{
	var r=confirm("Apakah Anda Ingin Menghapus No Rekening "+coano+" ini ?")
	if (r==true)
	{
		window.location = url+"index.php/transaksi/credit_note/delete_detail/"+cndid+"/"+coano+"/"+adduser+"";	
	}
	else
	{
  		return false;
...
//edit
function deleteDetail2(cndid,coano,adduser,url)
{
	var r=confirm(".Apakah Anda Ingin Menghapus No Rekening "+coano+" ini ?")
	if (r==true)
	{
		window.location = url+"index.php/transaksi/credit_note/delete_detail2/"+cndid+"/"+coano+"/"+adduser+"";	
	}
	else
	{
  		return false;
...
function pickThis(obj)
{
	...
	if(v_cnno=="")
	{
		...
		url = base_url+"index.php/pop/pop_up_credit_note/index/00000/0/1/";
	...
	else
	{
		...
		//alert(id);
		//url = base_url+"index.php/pop/pop_up_sales_invoice/index/0/"+id+"/";
		url = base_url+"index.php/pop/pop_up_credit_note/index/"+v_cnno+"/0/1/";
		windowOpener(650, 600, 'Cari Account Pick List', url, 'Cari Account Pick List')
	}
