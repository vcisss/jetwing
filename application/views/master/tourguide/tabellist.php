...
<form method="POST"  name="search" action='<?php echo base_url(); ?>index.php/master/tourguide/search'>
	...
	<div class="row">
		...
		<div class="col-md-2" align="right">
			...
			<a href="<?php echo base_url()."index.php/master/tourguide/add_new/"; ?>" onClick="show_loading_bar(100)" class="btn btn-info btn-icon btn-sm icon-left" title="" >Tambah<i class="entypo-plus"></i></a>
		</div>
	</div>
</form>
	...
	<table class="table table-bordered responsive">
        <thead class="title_table">
			<tr>
				...
				<th class="col-xs-10"><center>Nama Tour Guide</center></th>
		...
		foreach($data as $val)
		{
			...
			<tr style="cursor:pointer; <?php echo $bgcolor; ?>" onmouseover="change_onMouseOver('<?php echo $no; ?>')" onmouseout="change_onMouseOut('<?php echo $no; ?>')" id="<?php echo $no; ?>">
				<td><?php echo $no; ?></td>
                <td align="left"><?php echo $val["NamaTourGuide"]; ?></td>
                <td align="center">
	                <a href="<?php echo base_url();?>index.php/master/tourguide/edit_form/<?php echo $val["KdTourGuide"]; ?>" class="btn btn-info btn-sm sm-new tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="Edit" title=""><i class="entypo-pencil"></i></a>
                </td>
            </tr>
			<?php	
