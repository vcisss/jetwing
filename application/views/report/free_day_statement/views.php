...
function PopUpToPDF(baseurl, tour)
    {
    	url = "index.php/report/free_day_statement/viewPrint/"+tour;
...
<div class="row">
    <div class="col-md-12" align="left">
		...
		<form method='post' name="theform" id="theform" action="<?php echo base_url();?>index.php/report/free_day_statement/search_report">
    	...
    	{
		?>
		<button type="button" class="btn btn-orange btn-icon btn-sm icon-left" name="btn_excel" id="btn_excel" onclick="PopUpToPDF('<?= base_url(); ?>','<?= $group_code; ?>')" value="Excel">Export To PDF<i class="entypo-download"></i></button>
    	<br><br>
		<?php	
		}
    	?>
    	...
    	?>
	    			...
	    			<tr>
	    				<td colspan="100%" align="center"><?php echo $template->header."<hr>";?></td>
	    			</tr>
	    			<tr>
				...
				<table border="1" width="60%" >
					...
					<tr height="80">
						<td colspan="3">&nbsp;&nbsp;<?=$no;?>&nbsp;&nbsp;GUEST SIGN</td>
						<td colspan="3"><img src="<?=$url.$guest;?>" width="120" alt=""/></td>
					</tr>
					<tr height="80">
						<td colspan="3">&nbsp;&nbsp;<?=$no;?>&nbsp;&nbsp;TL SIGN</td>
						<td colspan="3"><img src="<?=$url.$tl;?>" width="120" alt=""/></td>
					</tr>
					<tr height="80">
						<td colspan="3">&nbsp;&nbsp;<?=$no;?>&nbsp;&nbsp;GUIDE SIGN</td>
						<td colspan="3"><img src="<?=$url.$guide;?>" width="120" alt=""/></td>
					</tr>
...
function cari_group(url)
		{
			...
			$.ajax({
					url: url+"index.php/report/free_day_statement/ajax_group/",
					data: {id:act},
					type: "POST",
					dataType: 'html',					
