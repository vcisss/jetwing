...
function PopUpToPDF(baseurl, tour)
    {
    	url = "index.php/report/optional_tour_agreement/viewPrint/"+tour;
...
<div class="row">
    <div class="col-md-12" align="left">
		...
		<form method='post' name="theform" id="theform" action="<?php echo base_url();?>index.php/report/optional_tour_agreement/search_report">
    	...
    	?>
	    			...
	    			<tr>
	    				<td colspan="100%"><h4><b><?php echo "(Herewith, I/We Agree to Add Schedule as below)<br>文章的作者是寫<br>".$tour[0]['schedule_text'];?></b></h4></td>
	    			</tr>
	    			<tr>
	    				<td colspan="100%"><h4><b><?php echo "(Therefore, I\We will have no complain)<br>文章的作者是寫, 文章的作者是寫.<br>".$tour[0]['complain_text'];?></b></h4></td>
	    			</tr>
	    			<tr>
				...
				$url = "http://".$pisah[2]."/claim_tour_API/img/form/opt/";
				?>
...
function cari_group(url)
		{
			...
			$.ajax({
					url: url+"index.php/report/optional_tour_agreement/ajax_group/",
					data: {id:act},
					type: "POST",
					dataType: 'html',					
