...
<form method="POST"  name="search" action='<?php echo base_url(); ?>index.php/transaksi/komisi/search'>
	...
	<div class="row">
		...
		<div class="col-md-2" align="right">
			...
			<a href="<?php echo base_url()."index.php/transaksi/komisi_per_pax/add_new/"; ?>" onClick="show_loading_bar(100)" class="btn btn-info btn-icon btn-sm icon-left" title="" >Tambah<i class="entypo-plus"></i></a>
		</div>
	</div>
</form>
