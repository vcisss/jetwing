...
<form method="POST"  name="search" action='<?php echo base_url(); ?>index.php/transaksi/komisi/cari'>
	...
	<div class="row">
		...
		<div class="col-md-4" align="right">
			...
			<a href="<?php echo base_url()."index.php/transaksi/komisi/add_new/"; ?>" onClick="show_loading_bar(100)" class="btn btn-success btn-icon btn-sm icon-left" title="" >Semua Komisi<i class="entypo-plus"></i></a>
			<a href="<?php echo base_url()."index.php/transaksi/komisi/add_new_komisi_tertentu/"; ?>" onClick="show_loading_bar(100)" class="btn btn-orange btn-icon btn-sm icon-left" title="" >Komisi Tertentu<i class="entypo-plus"></i></a>
		</div>
	</div>
</form>
	...
	<table class="table table-bordered responsive">
        <thead class="title_table">
			<tr>
				...
				<th class="col-xs-1"><center>Nama Tour</center></th>
				<th class="col-xs-2"><center>Nama Guide</center></th>
				<th class="col-sm-1"><center>Type</center></th>
				<!--<th class="col-xs-1"><center>Komisi Guide(Rp)</center></th>
				<th class="col-xs-1"><center>Komisi Tour Leader(Rp)</center></th>
				<th class="col-xs-1"><center>Komisi Guide(Rp)</center></th>-->
		...
		foreach($data as $val)
		{
			...
			<tr style="cursor:pointer; <?php echo $bgcolor; ?>" onmouseover="change_onMouseOver('<?php echo $no; ?>')" onmouseout="change_onMouseOut('<?php echo $no; ?>')" id="<?php echo $no; ?>">
                ...
                <td align="center"><?php echo $val["NamaTour"]; ?></td>
                <td align="center"><?php echo $val["NamaGuide"]; ?></td>
                <td align="center"><?php echo $val["Type"]; ?></td>
                <!--<td align="center"><?= number_format($val["Total_Komisi"]) ; ?></td>-->
                <td align="center">
	                <!--<a href="<?php echo base_url();?>index.php/transaksi/komisi/edit_form/<?php echo $val["NoTransaksi"]; ?>" class="btn btn-info btn-sm sm-new tooltip-primary" data-toggle="tooltip" data-placement="top" data-original-title="Edit" title=""><i class="entypo-pencil"></i></a>-->
...
<script>
    ...
    {
        url = "index.php/transaksi/komisi/create_pdf/" + escape(kode);
