<?php
class Visitor_information_model extends CI_Model {
    ...
    function getTabelList($limit,$offset,$arrSearch)
	{
    	...
    	$sql = "SELECT * FROM template Where 1 $where_keyword LIMIT $offset,$limit";
    ...
    function num_tabel_row($arrSearch)
    {
    	...
    	$sql = "SELECT * FROM template Where 1 $where_keyword";
