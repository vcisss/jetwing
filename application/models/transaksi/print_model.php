...
class Print_model extends CI_Model {
	...
	function getPT()
	{
		  $sql = "Select NamaPT as Nama,Alamat1PT as Alamat1,Alamat2PT as Alamat2,'' as Kota,
				NamaPT ,Alamat1PT ,Alamat2PT,TelpPT, NPWP from aplikasi ORDER BY Tahun DESC LIMIT 0,1";
